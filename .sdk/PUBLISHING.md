...
|---|---|---|
| `ts/` | @voxgig-sdk/inno-cyber-authentication-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/inno-cyber-authentication-sdk \
      --repository voxgig-sdk/inno-cyber-authentication-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/inno-cyber-authentication-sdk` shows it, and
`npm trust revoke @voxgig-sdk/inno-cyber-authentication-sdk --id=<id>` removes it.
