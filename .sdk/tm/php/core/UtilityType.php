...
// InnoCyberAuthentication SDK utility type

class InnoCyberAuthenticationUtility
{
    ...
    public static function copy(InnoCyberAuthenticationUtility $src): InnoCyberAuthenticationUtility
    {
        $u = new InnoCyberAuthenticationUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
