...
// InnoCyberAuthentication SDK audit feature
...
class InnoCyberAuthenticationAuditFeature extends InnoCyberAuthenticationBaseFeature
{
    ...
    private function _emit(InnoCyberAuthenticationContext $ctx, string $outcome): void
    {
