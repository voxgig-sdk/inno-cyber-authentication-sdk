...
// InnoCyberAuthentication SDK cache feature
...
class InnoCyberAuthenticationCacheFeature extends InnoCyberAuthenticationBaseFeature
{
    ...
    private function _through(InnoCyberAuthenticationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
