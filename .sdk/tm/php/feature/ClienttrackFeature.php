...
// InnoCyberAuthentication SDK clienttrack feature
...
class InnoCyberAuthenticationClienttrackFeature extends InnoCyberAuthenticationBaseFeature
{
    ...
    public function PostConstruct(InnoCyberAuthenticationContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'InnoCyberAuthentication-SDK';
