...
// InnoCyberAuthentication SDK proxy feature
...
class InnoCyberAuthenticationProxyFeature extends InnoCyberAuthenticationBaseFeature
{
    ...
    public function init(InnoCyberAuthenticationContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (InnoCyberAuthenticationContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
