...
// InnoCyberAuthentication SDK rbac feature
...
class InnoCyberAuthenticationRbacFeature extends InnoCyberAuthenticationBaseFeature
{
    ...
    private function _required(InnoCyberAuthenticationContext $ctx): ?string
    {
    ...
    private function _reject(InnoCyberAuthenticationContext $ctx, string $required): void
    {
    ...
    private function _track(InnoCyberAuthenticationContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
