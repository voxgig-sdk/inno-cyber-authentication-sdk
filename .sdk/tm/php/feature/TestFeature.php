...
// InnoCyberAuthentication SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class InnoCyberAuthenticationTestFeature extends InnoCyberAuthenticationBaseFeature
{
    ...
    public function init(InnoCyberAuthenticationContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (InnoCyberAuthenticationContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = InnoCyberAuthenticationParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (InnoCyberAuthenticationContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(InnoCyberAuthenticationContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = InnoCyberAuthenticationParam::call($ctx, $k);
