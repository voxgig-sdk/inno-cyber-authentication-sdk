...
// InnoCyberAuthentication SDK timeout feature
...
class InnoCyberAuthenticationTimeoutFeature extends InnoCyberAuthenticationBaseFeature
{
    ...
    private function _with_timeout(InnoCyberAuthenticationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(InnoCyberAuthenticationContext $_ctx, float $ms): void
    {
        $client = $this->client;
