...
// InnoCyberAuthentication SDK utility: fetcher

class InnoCyberAuthenticationFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; InnoCyberAuthenticationSDK/1.0)';
    ...
    public static function call(InnoCyberAuthenticationContext $ctx, string $fullurl, array $fetchdef): array
    {
