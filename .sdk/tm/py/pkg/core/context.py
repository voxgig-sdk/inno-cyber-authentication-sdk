...
from projectname_sdk.core.control import InnoCyberAuthenticationControl
...
class InnoCyberAuthenticationContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = InnoCyberAuthenticationControl()
        ...
        if isinstance(sp, InnoCyberAuthenticationSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, InnoCyberAuthenticationResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, InnoCyberAuthenticationResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return InnoCyberAuthenticationOperation({})
        ...
        op = InnoCyberAuthenticationOperation({
            "entity": entname,
            "name": opname,
            "input": inpt,
            "points": points,
    ...
    def make_error(self, code, msg):
        return InnoCyberAuthenticationError(code, msg, self)
