...
class InnoCyberAuthenticationTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = InnoCyberAuthenticationTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = InnoCyberAuthenticationTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = InnoCyberAuthenticationTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
