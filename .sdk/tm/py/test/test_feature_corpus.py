# InnoCyberAuthentication SDK feature corpus test
#
...
def _client(kase):
    ...
    InnoCyberAuthenticationSDK(...), not InnoCyberAuthenticationSDK.test(...): the `test` feature is
    ...
    return InnoCyberAuthenticationSDK(opts)
