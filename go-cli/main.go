// Command InnoCyberAuthentication-cli is a CLI + REPL for the InnoCyberAuthentication SDK,
...
const prompt = "inno-cyber-authentication"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      INNO_CYBER_AUTHENTICATION_APIKEY (api key), INNO_CYBER_AUTHENTICATION_BASE (base url override)")
