...
func registerSDKWords(r *eng.Registry, client *sdk.InnoCyberAuthenticationSDK) {
...
func runOp(client *sdk.InnoCyberAuthenticationSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
