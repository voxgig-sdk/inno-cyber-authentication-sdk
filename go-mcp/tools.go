...
func registerTools(server *mcp.Server, client *sdk.InnoCyberAuthenticationSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "inno-cyber-authentication_list",
		Description: "List records from InnoCyberAuthentication. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "inno-cyber-authentication_load",
		Description: "Load a single record from InnoCyberAuthentication. " +
...
func runOp(client *sdk.InnoCyberAuthenticationSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.InnoCyberAuthenticationSDK, name string) (sdk.InnoCyberAuthenticationEntity, error) {
