# InnoCyberAuthentication Golang SDK Reference

Complete API reference for the InnoCyberAuthentication Golang SDK.
...
#### `Test() *InnoCyberAuthenticationSDK`
...
#### `TestSDK(testopts, sdkopts map[string]any) *InnoCyberAuthenticationSDK`
...
#### `Authentication(data map[string]any) InnoCyberAuthenticationEntity`
