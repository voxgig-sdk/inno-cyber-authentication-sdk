...
// instead of `sdk.NewInnoCyberAuthenticationSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *InnoCyberAuthenticationSDK  { return NewInnoCyberAuthenticationSDK(nil) }
func Test() *InnoCyberAuthenticationSDK { return TestSDK(nil, nil) }
