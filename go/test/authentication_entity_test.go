...
func authenticationBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("INNO_CYBER_AUTHENTICATION_TEST_AUTHENTICATION_ENTID")
	...
	idmapResolved := core.ToMapAny(env["INNO_CYBER_AUTHENTICATION_TEST_AUTHENTICATION_ENTID"])
