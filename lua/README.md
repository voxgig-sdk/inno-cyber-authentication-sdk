...
The Lua SDK for the InnoCyberAuthentication API. Provides an entity-oriented interface using Lua conventions.
...
local result, err = client:InnoCyberAuthentication(nil):load(
  { id = "test01" }, nil
)
