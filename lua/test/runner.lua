...
function runner.env_override(m)
  local live = runner.getenv("INNOCYBERAUTHENTICATION_TEST_LIVE")
  local override = runner.getenv("INNOCYBERAUTHENTICATION_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("INNOCYBERAUTHENTICATION_TEST_EXPLAIN")
