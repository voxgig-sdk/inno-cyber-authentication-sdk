# InnoCyberAuthentication PHP SDK Reference

Complete API reference for the InnoCyberAuthentication PHP SDK.
...
#### `InnoCyberAuthenticationSDK::test($testopts = null, $sdkopts = null)`
