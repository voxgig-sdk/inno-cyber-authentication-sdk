...
// InnoCyberAuthentication SDK debug feature
...
class InnoCyberAuthenticationDebugFeature extends InnoCyberAuthenticationBaseFeature
{
    ...
    private function _finish(InnoCyberAuthenticationContext $ctx, bool $ok): void
    {
