...
// InnoCyberAuthentication SDK idempotency feature
...
class InnoCyberAuthenticationIdempotencyFeature extends InnoCyberAuthenticationBaseFeature
{
    ...
    private function _mutating(InnoCyberAuthenticationContext $ctx): bool
    {
