...
// InnoCyberAuthentication SDK netsim feature
...
class InnoCyberAuthenticationNetsimFeature extends InnoCyberAuthenticationBaseFeature
{
    ...
    private function _simulate(InnoCyberAuthenticationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(InnoCyberAuthenticationContext $ctx, array $applied): void
    {
        $client = $this->client;
