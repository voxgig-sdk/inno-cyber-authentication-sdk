...
// InnoCyberAuthentication SDK ratelimit feature
...
class InnoCyberAuthenticationRatelimitFeature extends InnoCyberAuthenticationBaseFeature
{
    ...
    private function _acquire(InnoCyberAuthenticationContext $ctx): void
    {
    ...
    private function _track(InnoCyberAuthenticationContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
