...
// InnoCyberAuthentication SDK streaming feature
...
class InnoCyberAuthenticationStreamingFeature extends InnoCyberAuthenticationBaseFeature
{
    ...
    private function _iterate(InnoCyberAuthenticationResult $result): \Generator
    {
    ...
    private function _streamable(InnoCyberAuthenticationContext $ctx): bool
    {
