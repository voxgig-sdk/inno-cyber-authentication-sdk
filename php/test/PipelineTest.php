...
// InnoCyberAuthentication SDK pipeline test
//
...
{
    private static function utility(): InnoCyberAuthenticationUtility
    {
        return new InnoCyberAuthenticationUtility();
    }
    ...
    private static function ctx(array $over = []): InnoCyberAuthenticationContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new InnoCyberAuthenticationContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new InnoCyberAuthenticationOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof InnoCyberAuthenticationError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new InnoCyberAuthenticationOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = InnoCyberAuthenticationMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new InnoCyberAuthenticationOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = InnoCyberAuthenticationMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new InnoCyberAuthenticationOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = InnoCyberAuthenticationMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new InnoCyberAuthenticationSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = InnoCyberAuthenticationMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        ...
        [, $err] = InnoCyberAuthenticationMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new InnoCyberAuthenticationSpec([]),
            'response' => null,
            'result' => new InnoCyberAuthenticationResult([]),
        ]);
        [, $err] = InnoCyberAuthenticationMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new InnoCyberAuthenticationSpec(['step' => 's']),
            'response' => new InnoCyberAuthenticationResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new InnoCyberAuthenticationResult([]),
        ]);
        [, $err] = InnoCyberAuthenticationMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new InnoCyberAuthenticationSpec(['step' => 's']),
            'response' => new InnoCyberAuthenticationResponse(self::resp(200, ['v' => 1])),
            'result' => new InnoCyberAuthenticationResult([]),
        ]);
        [, $err] = InnoCyberAuthenticationMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new InnoCyberAuthenticationSpec(['step' => 's']),
            'response' => new InnoCyberAuthenticationResponse(self::resp(200, ['v' => 2])),
            'result' => new InnoCyberAuthenticationResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        InnoCyberAuthenticationMakeResponse::call($ctx);
    ...
    {
        $preset = new InnoCyberAuthenticationResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new InnoCyberAuthenticationSpec([]),
            'response' => new InnoCyberAuthenticationResponse([]),
            'result' => new InnoCyberAuthenticationResult([]),
        ...
        [$got, $err] = InnoCyberAuthenticationMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new InnoCyberAuthenticationResult([])]);
        [, $err] = InnoCyberAuthenticationMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new InnoCyberAuthenticationSpec([]), 'result' => null]);
        [, $err] = InnoCyberAuthenticationMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new InnoCyberAuthenticationSpec(['step' => 's']),
            'result' => new InnoCyberAuthenticationResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new InnoCyberAuthenticationOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = InnoCyberAuthenticationMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new InnoCyberAuthenticationSpec(['step' => 's']),
            'result' => new InnoCyberAuthenticationResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new InnoCyberAuthenticationOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = InnoCyberAuthenticationMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new InnoCyberAuthenticationResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new InnoCyberAuthenticationSpec([]),
            'result' => new InnoCyberAuthenticationResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = InnoCyberAuthenticationMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = InnoCyberAuthenticationMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new InnoCyberAuthenticationError('boom', 'boom');
        $utility->fetcher = function (InnoCyberAuthenticationContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new InnoCyberAuthenticationSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = InnoCyberAuthenticationMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (InnoCyberAuthenticationContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = InnoCyberAuthenticationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(InnoCyberAuthenticationResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        InnoCyberAuthenticationMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (InnoCyberAuthenticationContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new InnoCyberAuthenticationSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = InnoCyberAuthenticationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new InnoCyberAuthenticationResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new InnoCyberAuthenticationSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = InnoCyberAuthenticationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = InnoCyberAuthenticationMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = InnoCyberAuthenticationMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new InnoCyberAuthenticationResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, InnoCyberAuthenticationDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new InnoCyberAuthenticationResult(['ok' => false])]);
        $this->expectException(InnoCyberAuthenticationError::class);
        InnoCyberAuthenticationDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new InnoCyberAuthenticationResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', InnoCyberAuthenticationMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        InnoCyberAuthenticationMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new InnoCyberAuthenticationBaseFeature();
        $b = new InnoCyberAuthenticationBaseFeature();
        InnoCyberAuthenticationFeatureAdd::call($ctx, $a);
        InnoCyberAuthenticationFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): InnoCyberAuthenticationBaseFeature
    {
        $f = new InnoCyberAuthenticationBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        InnoCyberAuthenticationFeatureAdd::call($ctx, self::named_feature('a'));
        InnoCyberAuthenticationFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        InnoCyberAuthenticationFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        InnoCyberAuthenticationFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        InnoCyberAuthenticationFeatureAdd::call($ctx, $replace);
        ...
        InnoCyberAuthenticationFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): InnoCyberAuthenticationContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new InnoCyberAuthenticationSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = InnoCyberAuthenticationPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        InnoCyberAuthenticationPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new InnoCyberAuthenticationResponse(['headers' => null]),
            'result' => new InnoCyberAuthenticationResult([]),
        ]);
        InnoCyberAuthenticationResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        InnoCyberAuthenticationResultBody::call($ctx);
