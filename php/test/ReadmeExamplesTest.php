...
// InnoCyberAuthentication SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (InnoCyberAuthenticationSDK::test)
...
{
    private const SDK_CLASS = 'InnoCyberAuthenticationSDK';
    ...
    private const SDK_BASE = 'innocyberauthentication_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../innocyberauthentication_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
