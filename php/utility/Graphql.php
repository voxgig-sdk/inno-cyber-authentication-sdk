...
// InnoCyberAuthentication SDK utility: graphql
//
...
class InnoCyberAuthenticationGraphql
{
    ...
    // equivalent.
    public static function body(InnoCyberAuthenticationContext $ctx): mixed
    {
    ...
    public static function errors(InnoCyberAuthenticationContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
