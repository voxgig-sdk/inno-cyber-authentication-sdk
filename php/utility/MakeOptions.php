...
// InnoCyberAuthentication SDK utility: make_options

class InnoCyberAuthenticationMakeOptions
{
    ...
    public static function call(InnoCyberAuthenticationContext $ctx): array
    {
        ...
        //
        // `InnoCyberAuthenticationSchema::optspec()` is built from the model:
        ...
        $optspec = InnoCyberAuthenticationSchema::optspec();
