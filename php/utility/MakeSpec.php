...
// InnoCyberAuthentication SDK utility: make_spec

require_once __DIR__ . '/Graphql.php';

require_once __DIR__ . '/../core/Spec.php';

class InnoCyberAuthenticationMakeSpec
{
    public static function call(InnoCyberAuthenticationContext $ctx): array
    {
        ...
        if ('graphql' === \Voxgig\Struct\Struct::getprop($point, 'kind')) {
            ...
            $ctx->spec->query = [];
            $ctx->spec->headers['content-type'] = InnoCyberAuthenticationGraphql::CONTENT_TYPE;
        } else {
