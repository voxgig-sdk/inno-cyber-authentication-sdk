...
// InnoCyberAuthentication SDK utility: result_basic

class InnoCyberAuthenticationResultBasic
{
    public static function call(InnoCyberAuthenticationContext $ctx): ?InnoCyberAuthenticationResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof InnoCyberAuthenticationError) ? $result->err->msg : (string)$result->err;
