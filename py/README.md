# InnoCyberAuthentication Python SDK



The Python SDK for the InnoCyberAuthentication API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/inno-cyber-authentication-sdk/releases)) or
...
```python
client = InnoCyberAuthenticationSDK.test(testopts, sdkopts)
```
...
```
py/
├── innocyberauthentication_sdk.py         -- Main SDK module
...
The main module (`innocyberauthentication_sdk`) exports the SDK class.
