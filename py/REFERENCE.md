# InnoCyberAuthentication Python SDK Reference

Complete API reference for the InnoCyberAuthentication Python SDK.
...
#### `InnoCyberAuthenticationSDK.test(testopts=None, sdkopts=None)`
