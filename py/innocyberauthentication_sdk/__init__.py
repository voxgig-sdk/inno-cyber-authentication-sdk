...
from innocyberauthentication_sdk.utility import register

# Load features
from innocyberauthentication_sdk.feature.base_feature import InnoCyberAuthenticationBaseFeature
from innocyberauthentication_sdk.features import _has_feature, _make_feature
...
class InnoCyberAuthenticationSDK:
    ...
    def get_utility(self):
        return InnoCyberAuthenticationUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("InnoCyberAuthenticationSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Authentication(self, data=None) -> "AuthenticationEntity":
        ...
        from innocyberauthentication_sdk.entity.authentication_entity import AuthenticationEntity
        return AuthenticationEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "InnoCyberAuthenticationSDK":
        if sdkopts is None:
            sdkopts = {}
