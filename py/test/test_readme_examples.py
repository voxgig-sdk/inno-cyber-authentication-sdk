# InnoCyberAuthentication SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions InnoCyberAuthenticationSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both InnoCyberAuthenticationSDK(...) and InnoCyberAuthenticationSDK.test(...) become
#      InnoCyberAuthenticationSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "innocyberauthentication_sdk"
_SDK_CLASS = "InnoCyberAuthenticationSDK"
