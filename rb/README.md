# InnoCyberAuthentication Ruby SDK



The Ruby SDK for the InnoCyberAuthentication API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `InnoCyberAuthenticationError` (a `StandardError` subclass), so wrap
...
```
rb/
├── InnoCyberAuthentication_sdk.rb       -- Main SDK module
