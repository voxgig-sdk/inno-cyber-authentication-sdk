...
The Ruby SDK for the InnoCyberAuthentication API. Provides an entity-oriented interface using idiomatic Ruby conventions.
...
result, err = client.InnoCyberAuthentication(nil).load(
  { "id" => "test01" }, nil
)
