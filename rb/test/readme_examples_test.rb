...
#      offline in seeded test mode (InnoCyberAuthenticationSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "InnoCyberAuthentication_sdk.rb")
  SDK_CLASS = "InnoCyberAuthenticationSDK"
  ...
  SDK_BASE = "InnoCyberAuthentication_sdk"
