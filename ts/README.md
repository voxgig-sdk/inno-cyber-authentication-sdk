# InnoCyberAuthentication TypeScript SDK

The TypeScript SDK for the InnoCyberAuthentication API. Provides a type-safe, entity-oriented interface with full async/await support.
...
```ts
const client = new InnoCyberAuthenticationSDK({ apikey: '...' })
...
```ts
new InnoCyberAuthenticationSDK(options?: {
  apikey?: string
  base?: string
  prefix?: string
  suffix?: string
...
| `tester(testopts?, sdkopts?)` | `InnoCyberAuthenticationSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `InnoCyberAuthenticationSDK.test(testopts?, sdkopts?)` | `InnoCyberAuthenticationSDK` | Create a test-mode client. |
...
| `client` | `client(): InnoCyberAuthenticationSDK` | Return the parent SDK client. |
...
├── src/
│   ├── InnoCyberAuthenticationSDK.ts        # Main SDK class
