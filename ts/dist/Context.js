...
const InnoCyberAuthenticationError_1 = require("./InnoCyberAuthenticationError");
...
class Context {
    ...
    error(code, msg) {
        return new InnoCyberAuthenticationError_1.InnoCyberAuthenticationError(code, msg, this);
    }
    toJSON() {
        return {
            id: this.id,
