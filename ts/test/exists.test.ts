...
describe('exists', async () => {
  ...
  test('test-mode', () => {
    const testsdk = InnoCyberAuthenticationSDK.test()
    equal(testsdk instanceof InnoCyberAuthenticationSDK, true,
      'InnoCyberAuthenticationSDK.test() must return a client synchronously')
  })
